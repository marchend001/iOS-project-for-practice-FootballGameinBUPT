...
//  NokiaFootball
//
//  Created by 龚茜 on 17/1/17.
//  Copyright © 2017年 龚茜. All rights reserved.
//

import UIKit

class GroupPicViewController: UITableViewController {
    
    let group:NSArray = ["A组","B组","C组"]
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = self.group.objectAtIndex(indexPath.row) as! String
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        if(indexPath.row == 0){
            ...
            picViewController.title = self.group[selectRow] as? String
            picViewController.typeName = self.group[selectRow] as? String
